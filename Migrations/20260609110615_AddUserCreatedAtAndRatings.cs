...
{
    /// <inheritdoc />
    public partial class AddUserCreatedAtAndRatings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Backfill existing users with the migration timestamp (new signups set their own).
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RateeUserType = table.Column<int>(type: "integer", nullable: false),
